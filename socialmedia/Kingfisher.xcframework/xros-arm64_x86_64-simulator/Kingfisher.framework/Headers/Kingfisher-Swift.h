...
#ifndef KINGFISHER_SWIFT_H
#define KINGFISHER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Kingfisher",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (nonnull instancetype)initWithImage:(UIImage * _Nullable)image highlightedImage:(UIImage * _Nullable)highlightedImage OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(visionos,introduced=1.0);
...
@interface KFSessionDelegate (SWIFT_EXTENSION(Kingfisher)) <NSURLSessionDataDelegate>
